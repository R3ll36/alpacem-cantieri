...
export const MobileHeader: React.FC<MobileHeaderProps> = ({ theme, onToggleTheme, onLogout }) => {
  return (
    <header className="md:hidden flex items-center justify-between px-4 py-3 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-800/50 z-20 absolute top-0 left-0 right-0">
