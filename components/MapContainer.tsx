  ...
  return (
    <div className="w-full h-full relative bg-slate-100 dark:bg-slate-800 isolate">
      ...
      <button
        ...
        className="absolute top-4 right-4 z-[400] w-10 h-10 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-lg shadow-md flex items-center justify-center hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
