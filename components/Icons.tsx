...
import alpacemLogo from '../assets/Alpacem-Italia.png';

export const AlpacemLogo = ({ className }: { className?: string }) => (
...
export const TargetIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
     ...
     <path strokeLinecap="round" strokeLinejoin="round" d="M12 2v2m0 16v2m10-10h-2M4 12H2m17 0a7 7 0 11-14 0 7 7 0 0114 0z" />
  </svg>
);
